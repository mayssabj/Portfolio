        ...
        <div className="intro">
            <div className="i-left">
                ...
                <div className="i-icons">
                   <a href="https://github.com/mayssabj"> <img src={Github} alt="" /></a>
                   <a href="https://www.linkedin.com/in/ben-joud-mayssa-89b22722b/"> <img src={Linkdin} alt="" /></a>
                    <a href="https://www.instagram.com/mayssa_ben_joud/?hl=fr"><img src={Instagram} alt="" /></a>
                </div>
            </div>
            ...
            <div style={{top:'-4%', left:'68%'}}>
                <FloatingDiv image={Crown} text1='Web' text2='Devolper'/>
            </div>
